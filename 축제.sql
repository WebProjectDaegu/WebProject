...
남녀노소 참여가능한 체험 및 공연프로그램', '033-553-6900', 'http://tbcf.or.kr/', '태백시문화재단', '37.16291444', '128.985252013', '2022-01-14', '2022-01-23') WHERE NOT EXISTS (SELECT name FROM festival WHERE name = '태백산눈축제');
