...
select '태백산눈축제', '태백산국립공원 당골광장 및 태백문화광장 등 태백시 일원', '전국 대학생 눈조각 경연대회, 눈꽃 등반대회, 먹거리 장터, 별빛 프로그램, 
남녀노소 참여가능한 체험 및 공연프로그램', '033-553-6900', 'http://tbcf.or.kr/', '태백시문화재단', '37.16291444', '128.985252013', '2022-01-14', '2022-01-23' from dual WHERE NOT EXISTS (SELECT name FROM festival WHERE name = '태백산눈축제');
